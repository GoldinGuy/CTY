...
{	
	...
	public static void main (String[] args) throws IOException
	{
		...
		while (on)
		{
			...
			cpmove(board, puter, player); // puter move
			on=check(board, player); // check
	...
	static void cpmove(String[][] board, String puter, String player)
	{
	...
	Rnd1=randomNumbers.nextInt(3); 
	Rnd2=randomNumbers.nextInt(3); 



				if ((a==0) & (board[0][0].equals(player)) | (board[0][2].equals(player)) | (board[2][0].equals(player) | (board[2][2].equals(player))
				{
					if (board[1][1]==("[ ]"))
					{
						board[1][1]=(puter);
